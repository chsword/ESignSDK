...
namespace ESignSDK
{
    public partial class ESignSDKClient
    {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<ApiResult<AccountCreateByThirePartyUserIdResponse>>
            AccountCreateByThirdPartyUserId(Requests.AccountCreateByThirePartyUserIdRequest request)
        {
